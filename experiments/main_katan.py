"""
================================================================================
KATAN EXPERIMENT RUNNER
================================================================================

OVERVIEW:
This script is the main entry point for running Machine Learning experiments 
on the KATAN block cipher. It evaluates how well various models can 
approximate the cipher's behavior at reduced rounds.

KATAN CONTEXT:
KATAN is a family of lightweight block ciphers designed for extremely 
constrained hardware like RFID tags. It uses a Shift Register approach, 
where bits are taken from specific positions on two registers and combined 
using simple logic to update the state.

THE PIPELINE:
1. DATASET GENERATION:
   - Uses the 'katan' module in 'ciphers/' to generate plaintext-ciphertext pairs.
...
def main():
    print("=" * 65)
    print("  KATAN  x  Logistic, MLP, CNN, MINE, RF  x  r = 1,2,3,4,5")
    print("=" * 65)

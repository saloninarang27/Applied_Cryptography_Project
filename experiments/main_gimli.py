"""
================================================================================
GIMLI EXPERIMENT RUNNER
================================================================================

OVERVIEW:
This script is the main entry point for running Machine Learning experiments 
on the Gimli permutation. It evaluates how well various models can 
...
security across many different types of computer processors. It arranges 
its 384 bits as a 3x4 matrix of 32-bit words and repeatedly applies 
non-linear and linear mixing layers.

THE PIPELINE:
1. DATASET GENERATION:
   - Uses the 'gimli' module in 'ciphers/' to generate plaintext-ciphertext pairs.
...
def main():
    print("=" * 65)
    print("  GIMLI  x  Logistic, MLP, CNN, MINE, RF  x  r = 1,2,3,4,5")
    print("=" * 65)

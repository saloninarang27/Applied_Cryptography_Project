...
on the RECTANGLE block cipher. It evaluates how well various models can 
approximate the cipher's behavior at reduced rounds (1 to 5).

RECTANGLE CONTEXT:
RECTANGLE is a lightweight block cipher that uses a bit-slice architecture. 
It is designed for efficient implementation in both hardware and software, 
employing a simple Substitution-Permutation Network (SPN) structure that 
is particularly well-suited for side-channel resistance and low-cost devices.

THE PIPELINE:
1. DATASET GENERATION:
   - Generates RECTANGLE datasets for rounds 1 to 5.
2. MULTI-MODEL ANALYSIS:
   - Evaluates Logistic Regression, MLP, CNN, MINE, and Random Forest.
3. RESULTS:
   - Saves metrics, produces plots, and generates a comparison report.
"""
...
def main():
    print("=" * 70)
    print("  RECTANGLE  x  Logistic, MLP, CNN, MINE, RF  x  r = 1,2,3,4,5")
    print("=" * 70)

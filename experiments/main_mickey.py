"""
================================================================================
MICKEY 2.0 EXPERIMENT RUNNER
================================================================================

OVERVIEW:
This script is the main entry point for running Machine Learning experiments 
on the MICKEY 2.0 stream cipher. It evaluates how well various models can 
...
designed for hardware efficiency. It was a finalist in the eSTREAM project 
and is known for its irregular clocking mechanism, which provides strong 
resistance against many types of cryptanalysis.

THE PIPELINE:
1. DATASET GENERATION:
   - Generates MICKEY datasets for reduced rounds.
...
def main():
    print("=" * 66)
    print("  MICKEY  x  Logistic, MLP, CNN, MINE, RF  x  r = 1,2,3,4,5")
    print("=" * 66)

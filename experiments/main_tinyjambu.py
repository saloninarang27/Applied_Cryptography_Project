"""
================================================================================
TinyJAMBU EXPERIMENT RUNNER
================================================================================

OVERVIEW:
This script is the main entry point for running Machine Learning experiments 
on the TinyJAMBU lightweight AEAD. It evaluates how well various models can 
approximate the cipher's behavior at reduced rounds (1 to 5).

TinyJAMBU CONTEXT:
TinyJAMBU is a lightweight authenticated encryption with associated data 
(AEAD) design. It uses a 128-bit keyed permutation and is centered on a 
compact nonlinear state update. It was selected as a finalist in the NIST 
Lightweight Cryptography competition.

THE PIPELINE:
1. DATASET GENERATION:
   - Creates TinyJAMBU datasets for rounds 1 to 5.
2. MULTI-MODEL ANALYSIS:
   - Tests performance using Logistic Regression, MLP, CNN, MINE, and RF.
3. CONSOLIDATION:
   - Generates metrics, plots, and comparison reports for analysis.
"""
...
def main():
    print("=" * 72)
    print("  TINYJAMBU  x  Logistic, MLP, CNN, MINE, RF  x  r = 1,2,3,4,5")
    print("=" * 72)

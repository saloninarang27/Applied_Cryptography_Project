"""
================================================================================
LEA EXPERIMENT RUNNER
================================================================================

OVERVIEW:
This script is the main entry point for running Machine Learning experiments 
on the LEA block cipher. It evaluates how well various models can 
approximate the cipher's behavior at reduced rounds (1 to 5).

LEA CONTEXT:
LEA is a 128-bit block cipher designed for high-speed software 
implementations. It is an "ARX" cipher, meaning it only uses Addition, 
Rotation, and XOR operations, making it very efficient on standard CPUs.

THE PIPELINE:
1. DATASET GENERATION:
   - Uses the 'lea' module in 'ciphers/' to generate plaintext-ciphertext pairs.
...
def main():
    print("=" * 65)
    print("  LEA  x  Logistic, MLP, CNN, MINE, RF  x  r = 1,2,3,4,5")
    print("=" * 65)
